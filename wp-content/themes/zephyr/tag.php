...
<div id="content" class="<?php echo $class; ?>">
	<div id="category-top" class="col-md-12 col-sm-12 col-xs-12">
		...
		<span class="circle accentbg"></span><span><?php _e('Tag', 'zephyr'); ?> - <span class="cat-name"><?php single_tag_title(); ?></span><br />
		<span class="postcount"><?php if ( $count == 1 ) { echo $count.' '.__('post', 'zephyr'); } elseif ( $count == 0 ) { _e('No posts', 'zephyr'); } else { echo $count .' '.__('posts', 'zephyr'); } ?></span>
	</div>
