 ...
 *
 * If you are making your theme translatable, you should replace 'tafars'
...
function optionsframework_options() {
	...
	$options[] = array(
		'name' => __('Header Meta', 'tafars'),
		'type' => 'heading');

// Standard Meta
	$options[] = array(
		'name' => __('Head ID', 'tafars'),
		'desc' => __("", 'tafars'),
		'id' => 'meta_headid',
		'std' => 'tafars',
		'type' => 'text');
	$options[] = array(
		'name' => __('Google Webmasters', 'tafars'),
		'desc' => __("Speaking of Google, don't forget to set your site up: <a href='http://google.com/webmasters' target='_blank'>http://google.com/webmasters</a>", 'tafars'),
		'id' => 'meta_google',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('Author Name', 'tafars'),
		'desc' => __('Populates meta author tag.', 'tafars'),
		'id' => 'meta_author',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('Mobile Viewport', 'tafars'),
		'desc' => __('Uncomment to use; use thoughtfully!', 'tafars'),
		'id' => 'meta_viewport',
...
// Icons
	$options[] = array(
		'name' => __('Site Favicon', 'tafars'),
		'desc' => __('', 'tafars'),
		'id' => 'head_favicon',
		'type' => 'upload');
	$options[] = array(
		'name' => __('Apple Touch Icon', 'tafars'),
		'desc' => __('', 'tafars'),
...
// App: Windows 8
	$options[] = array(
		'name' => __('App: Windows 8', 'tafars'),
		'desc' => __('Application Name', 'tafars'),
		'id' => 'meta_app_win_name',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('', 'tafars'),
		'desc' => __('Tile Color', 'tafars'),
		'id' => 'meta_app_win_color',
		'std' => '',
		'type' => 'color');
	$options[] = array(
		'name' => __('', 'tafars'),
		'desc' => __('Tile Image', 'tafars'),
...
// App: Twitter
	$options[] = array(
		'name' => __('App: Twitter Card', 'tafars'),
		'desc' => __('twitter:card (summary, photo, gallery, product, app, player)', 'tafars'),
		'id' => 'meta_app_twt_card',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('', 'tafars'),
		'desc' => __('twitter:site (@username of website)', 'tafars'),
		'id' => 'meta_app_twt_site',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('', 'tafars'),
		'desc' => __("twitter:title (the user's Twitter ID)", 'tafars'),
		'id' => 'meta_app_twt_title',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('', 'tafars'),
		'desc' => __('twitter:description (maximum 200 characters)', 'tafars'),
		'id' => 'meta_app_twt_description',
		'std' => '',
		'type' => 'textarea');
	$options[] = array(
		'name' => __('', 'tafars'),
		'desc' => __('twitter:url (url for the content)', 'tafars'),
		'id' => 'meta_app_twt_url',
		'std' => '',
		'type' => 'text');
...
// App: Facebook
	$options[] = array(
		'name' => __('App: Facebook', 'tafars'),
		'desc' => __('og:title', 'tafars'),
		'id' => 'meta_app_fb_title',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('', 'tafars'),
		'desc' => __('og:description', 'tafars'),
		'id' => 'meta_app_fb_description',
		'std' => '',
		'type' => 'textarea');
	$options[] = array(
		'name' => __('', 'tafars'),
		'desc' => __('og:url', 'tafars'),
		'id' => 'meta_app_fb_url',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('', 'tafars'),
		'desc' => __('og:image', 'tafars'),
